...
public class PageDeFin {
	...
	public void createContents(Shell shell) {
		...
		//Si l'utilisateur change la taille de la fenêtre la fonction refresh est appelée pour actualiser la taille des éléments
			...
			btnRestart.addListener(SWT.Selection, new Listener() {
				public void handleEvent(Event e) {
					...
					case SWT.Selection:
						...
						//On relance une partie vierge avec les même paramètres
	...
	/**
	 * La fonction refresh actualise la taille des éléments en fonction de la taille de la fenêtre
	 */
	public void refresh() {
