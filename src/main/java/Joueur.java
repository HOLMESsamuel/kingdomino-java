...
public class Joueur {
	...
	/**
	 * Le constructeur crée un joueur avec les données en paramétre
	 * @param col
	 * @param isIA
	 * @param name
	 */
	 ...
	 * @param tailleT la taille du royaume é creer (pour unn 5*5 ou 7*7)
	 */
	...
	/**
	 * Remplace le royaume du joueur par celui entré en paramétre
	 * @param roy
	 */
	...
	/**
	 * Remplace la prochaine tuile du joueur par celle entrée en paramétre
	 * @param nb
	 */
	...
	/**
	 * La fonction setScore donne le score entré en paramétre é la partie également en paramétre au joueur
	 * @param score
	 * @param i
	 */
