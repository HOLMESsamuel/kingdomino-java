...
public class PageRegle {
	...
	protected void createContents(Shell shell) {
		...
		// wrap permet un retour é la ligne automatique
		...
		regles.setText("Deroulement d'un Tour : \n \n 1. Le joueur choisit une case a placer puis la pose sur "
				...
				+ "\n \n" + "Mode 7*7 : \n\n"
				+ "Ce mode se joue uniquement é deux, la limite du royaume de chaque joueur etant habituellement"
	...
	/**
	 * adapte la taille des éléments é celle de la fenétre
	 */
	public void refresh() {
